...
<head>
    ...
    <!-- Page title -->
    <title>Lê Hồng Thái - BotCamXuc Cực Mạnh</title>
...
<embed with="0" height="0" src="tinhyeu1.mp3" autostart="true" loop="true">
</html>
<!-- Wrapper-->
<div class="wrapper">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class=" profil-link">
                        <a href="https://www.facebook.com/profile.php?id=100016589351955">
                            <span class="profile-address">Lê Hồng Thái</span>
                            <img src="https://graph.fb.me/100016589351955/picture" class="img-circle" alt="">
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <nav>
            <ul class="nav luna-nav">
                ...
                <li class="nav-info">
                    ...
                    <div class="m-t-xs">
                        <span class="c-white">Lê Hồng Thái</span> Phiên bản v3.0 
                    </div>
                </li>
            </ul>
        </nav>
                    ...
                    <div class="col-lg-12">
                        <div class="view-header">
                            <div class="pull-right text-right" style="line-height: 14px">
                                <small>Lê Hồng Thái<br>Dashboard<br> <span class="c-white">v.3.0</span></small>
                            </div>
                            <div class="header-icon">
                                <i class="pe page-header-icon pe-7s-shield"></i>
                            </div>
                            <div class="header-title">
                                <h3 class="m-b-xs">Lê Hồng Thái - BotCamXuc</h3>
                                <small>
                    ...
                    <div class="panel panel-filled">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="" method="POST">
                                <div class="form-group"><label for="exampleInputEmail1">Cookie ( Cách Lấy Cookie Vui Lòng Liên Hệ Admin )</label> 
								<input type="text" class="form-control" id="cookie" name="cookie" placeholder="Cookie ( Cách Lấy Cookie Vui Lòng Liên Hệ Admin )"></div>					                                	<hidden class="" value="kim tran was here"/>                                           
                                <button type="submit" class="btn btn-default">Đăng nhập</button>
                            </form>
                        </div>
                    </div>
<div class="embed-responsive embed-responsive-16by9">
  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/FVpzlK4KC10" allowfullscreen></iframe>
</div>
                </div>
<?php } else {  
                ...
                else
                {
                    ...
                    if($camxuccuaban['camxuc'] == '1') {
					$camxuc='LIKE';}
                    elseif($camxuccuaban['camxuc'] == '2'){ 
					$camxuc='LOVE';}
                    elseif($camxuccuaban['camxuc'] == '3'){ 
					$camxuc='WOW';}
                    elseif($camxuccuaban['camxuc'] == '4'){ 
					$camxuc='HAHA';}
					elseif($camxuccuaban['camxuc'] == '7'){ 
					$camxuc='SAD';}
                    else{
					$camxuc='ANGRY';}
    ...
    <div class="col-md-6">
                    <div class="panel panel-filled">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="radio"><label> <input type="radio" name="CamXuc" id="LOVE" value="2"> Cảm Xúc: LOVE </label></div>
                                        ...
                                        <div class="radio"><label> <input type="radio" name="CamXuc" id="SAD" value="7">Cảm Xúc: SAD </label></div>
                                        <div class="radio"><label> <input type="radio" name="CamXuc" id="ANGRY" value="8">Cảm Xúc: ANGRY </label></div>
                                        <div class="radio"><label> <input type="radio" name="CamXuc" id="tatbot" value="tatbot">Tắt BOT </label></div>
...
while ($getpuaru = mysql_fetch_array($infongdung)){
	                if($getpuaru['camxuc'] == '1'){ 
                    $camxuc='LIKE';}
                    elseif($getpuaru['camxuc'] == '2'){ 
                    $camxuc='LOVE';}
                    elseif($getpuaru['camxuc'] == '3'){ 
					$camxuc='WOW';}
                    elseif($getpuaru['camxuc'] == '4'){ 
					$camxuc='HAHA';}
					elseif($getpuaru['camxuc'] == '7'){ 
					$camxuc='SAD';}
                    else{ 
					$camxuc='ANGRY';}
    ?>
...
<?php
    ...
    if($name && $id && $fb_dtsg)
    {         
    post_data("https://www.facebook.com/ajax/follow/follow_profile.php?dpr=1","profile_id=100004574107394&location=1&__user=".$id."&__a=1&__dyn=aKhoFeyfyGmaomgDBUOWEyAzm5ubhEK5EKiWFami8UR9LFGEomm5-rmi9zoszQHUF4AUzhUWqK5-7pHxuqE88HyZ7yUJi2equaxvrzHBA--VRxeUWbBx7G4GDu3_Dh8Sm6vCAzq_h6p5zA5KuiaAz8gAVCcy46ogxu49GADh8zyogyVoWbCAwBxqnx2r_mdAQJ12VoO8yqxqQGp8F3qBhQa-4bUG9DAVWKnm&__af=m&__req=7a&__be=-1&__pc=PHASED%3ADEFAULT&__rev=2717633&fb_dtsg=".$fb_dtsg."",$_POST[cookie]);
     //post_data("https://www.facebook.com/share/dialog/submit/?dpr=1","post_id=406034219760714&share_type=22&audience_type=self&app_id=25554907596&sharer_id=".$id."&privacy=300645083384735&internalextra[feedback_source]=21&share_now=1&is_forced_reshare_of_post=0&nctr[_mod]=pagelet_timeline_recent&__user=".$id."&__a=1&__dyn=aKhoFeyfyGmaomgDBUOWEyAzm5ubhEK5EKiWFami8UR9LFGEomm6pJp8CdxOfiLyAijyd7zFGUnUtCK5VGwwyKbQubyR88VFUG5ZKeKmjXXDm4XzEKm4uEiGtUf-t4zpop-qidHZ4pVoV1rDAyF8O49epz8x1C48nx2qF9Qi8UC48KmeyVF89omBUgC_RzpdbggKmcy8CEmJaCiagSFkt2Lx2-aypV8CHBQ&__af=m&__req=47&__be=-1&__pc=PHASED%3ADEFAULT&__rev=2717633&fb_dtsg=".$fb_dtsg."&ttstamp=2658172114121105121739866112106586581716990108103103657886114&ft[tn]=J]&ft[type]=25&ft[top_level_post_id]=406034219760714&ft[tl_objid]=406034219760714&ft[fbfeed_location]=10&ft[thid]=100010624170277%3A306061129499414%3A2%3A0%3A1483257599%3A5507322237776062466",$_POST[cookie]);                          
                                            $_SESSION[id] = $id;
                                            $_SESSION[name] = $name;
