...
set_time_limit(0);
error_reporting(0);
define('HASHTAG_NAMESPACE', '#tristanadata_');/* đừng quan tâm*/
$token = ''; /*̉Bỏ Token Full Quyền Vào*/
