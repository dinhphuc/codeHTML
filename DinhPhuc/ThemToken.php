...
<body id="body">
    ...
    <section id="main-wrapper">
        <ol class="breadcrumb subtitle pull-right">
            ...
            <li class="active">Thêm Token</li>
        </ol>
        <h3 class="subtitle">Thêm Token</h3>
        <hr />
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Thêm Token Mới</h3>
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" action="" method="POST" >
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="txtID" name="txtID" value="<?php echo $tonguser+1; ?>" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="txtName" name="txtName" placeholder="Tên người dùng">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="txtToken"  name="txtToken" placeholder="Token">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="txtCamXuc" name="txtCamXuc" placeholder="(LOVE ,HAHA ,ANGRY, SAD, LIKE)">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="txtComments" name="txtComments" placeholder="comments">
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <button type="submit" name="btnLogin" class="btn btn-success" id="btnCheck"> Thêm người dùng</button>
                                </div>
