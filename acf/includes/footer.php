	...
	function vip_package(){
		...
		function(result){
			...
			if(conlai<0){
				...
				exec_status('<div class="alert alert-block alert-danger fade in"><strong>Cảnh Báo</strong> Số Xu Trong Trong Tài Khoản Của Bạn Không Đủ. Nếu Bạn Muốn Sử Dụng Vui Lòng Nạp Thêm <a href="<?php echo $domain; ?>/vip-recharge.kBz" target="_blank">Tại Đây</a><br>Số Tiền Bị Thiếu: ' + number_format(bithieu) + ' Xu.</div><hr>');
			}
			else exec_status('');
