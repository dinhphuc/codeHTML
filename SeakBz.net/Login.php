    ...
    <div class="row">
        ...
        <form action = "" method = "post">
            <div class="form-login">
                    <h4>Welcome back.</h4>
                 <input maxlength="50" type="text"  name = "username" class="form-control input-sm chat-input" placeholder="username" />
                   </br>
                   <input  maxlength="50" type="password" name = "password" class="form-control input-sm chat-input" placeholder="password" />
                 </br>
                 <div class="wrapper">
